...
3. Setelah seluruh pasangan citra satelit dan anotasi objek bangunan selesai dibuat, kemudian buat folder baru untuk menyimpan set data dengan nama *Bangunan*. Dalam folder tersebut, kemudian buat dua folder dengan nama masing-masing *train* dan *validation*.
4. 
